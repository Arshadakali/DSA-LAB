...
root =tk.Tk
root.title("Drawing base")

canvas = tk.Canvas(root, width=400,heght=400,bg="white")
canvas.pack()

rect= tk.Canvas.create_rectangle(50, 50, 150, 150, fill="lightblue")
circle= tk.Canvas.create_oval(200, 50, 300, 150, fill="lightgreen")
triangle=tk.Canvas.create_polygon(100, 200, 50, 300, 150, 300, fill="pink")
...
btn_frame.pack(pady=10,side=tk.LEFT)
...
tk.Button(btn_frame, text="Exit", command=root.destroy).pack(pady=10)
root.mainloop()
